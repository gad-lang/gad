...
// runForError compiles src as a gadx module, runs its main comp, and returns
...
// TestPositionPreservationRuntime verifies that a nil-call inside various gadx
// constructs reports the correct source line and column in the runtime error
// stack trace. Before the fix, gadx never populated the source file's line table
