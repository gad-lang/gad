# CLAUDE.md - Development Context (gadx)

Style guide, commands, and architectural guidelines for developing the `gadx` template engine.
...
* **Performance & Hot-Paths:** As `gadx` is a rendering engine, keep allocation overhead low in the *Parser*, *Lexer*, and execution loops. Use `strings.Builder`, `sync.Pool`, or reusable buffers where applicable.
