...
// AppendBuiltins registers the gadx module as a non-loadable builtin namespace,
// making gadx.escape, gadx.attr, gadx.attrs, and gadx.write available globally.
