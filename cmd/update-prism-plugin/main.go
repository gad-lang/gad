// Command update-prism-plugin keeps web/plugins/js/prism-gad in sync with the Gad language:
...
func main() {
	pluginsync.RunCLI(pluginsync.Target{
		Name:   "prism-gad",
		Dir:    "web/plugins/js/prism-gad",
		File:   "web/plugins/js/prism-gad/src/index.ts",
