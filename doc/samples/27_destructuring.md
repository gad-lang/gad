...
27_destructuring.gad — binding several variables at once from arrays and named
data. Gad has three destructuring shapes:
...
See doc/collections.md and doc/variables-and-scopes.md for detailed documentation.

## Example — `27_destructuring.gad`
