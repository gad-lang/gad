...
[interface](24_interfaces.gad) it also **coerces** the value into the interface's
declared shape.
...
Run it: `gad test samples/38_transform_cast_test.gad`

## Example — `38_transform_cast_test.gad`
